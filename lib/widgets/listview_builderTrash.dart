...
class ListViewBuilderTrash extends StatefulWidget {

  @override
  State<ListViewBuilderTrash> createState() => _ListViewBuilderStateTrash();
}

class _ListViewBuilderStateTrash extends State<ListViewBuilderTrash> {
  @override
      ...
      builder: (context, snapshot) {
        return ListView.builder(
          ...
          itemBuilder: (context, index) {
            ...
            return book.trash == 1? Card(
              //will filter those that are in trash
