...
class ListViewBuilderFav extends StatefulWidget {

  @override
  State<ListViewBuilderFav> createState() => _ListViewBuilderStateFav();
}

class _ListViewBuilderStateFav extends State<ListViewBuilderFav> {
  @override
      ...
      builder: (context, snapshot) {
        return ListView.builder(
          ...
          itemBuilder: (context, index) {
            ...
            return book.favourite == 1? book.trash == 0? Card(
              //will filter those that is a favourite book and not in trash
