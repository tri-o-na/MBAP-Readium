...
class ListViewBuilderTBR extends StatefulWidget {

  @override
  State<ListViewBuilderTBR> createState() => _ListViewBuilderStateTBR();
}

class _ListViewBuilderStateTBR extends State<ListViewBuilderTBR> {
  @override
      ...
      builder: (context, snapshot) {
        return ListView.builder(
          ...
          itemBuilder: (context, index) {
            ...
            return book.toBeRead == 1? book.trash == 0? Card(
              //will filter those that are in to be read and not in trash
