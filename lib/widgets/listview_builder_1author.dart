...
class ListViewBuilder1Author extends StatefulWidget {
  String authorName;

  ListViewBuilder1Author(this.authorName);

  @override
  State<ListViewBuilder1Author> createState() => _ListViewBuilder1AuthorState();
}

class _ListViewBuilder1AuthorState extends State<ListViewBuilder1Author> {
  @override
...
//filter based on clicked author
      ...
      builder: (context, snapshot) {
        return ListView.builder(
          ...
          itemBuilder: (context, index) {
            ...
            return  book.authorName == widget.authorName? book.trash == 0? Card(
              //will filter those that have the same author name as the one selected at authors page and not in trash
