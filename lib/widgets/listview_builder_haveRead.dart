...
class ListViewBuilderHaveRead extends StatefulWidget {

  @override
  State<ListViewBuilderHaveRead> createState() => _ListViewBuilderStateHaveRead();
}

class _ListViewBuilderStateHaveRead extends State<ListViewBuilderHaveRead> {
  @override
      ...
      builder: (context, snapshot) {
        return ListView.builder(
          ...
          itemBuilder: (context, index) {
            ...
            return book.haveRead == 1? book.trash == 0? Card(
              //will filter those that are in have read and not in trash
