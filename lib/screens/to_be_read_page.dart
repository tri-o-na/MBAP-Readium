...
import '../widgets/listview_builder_TBR.dart';

class TBRPage extends StatelessWidget {
  static String routeName = '/tbr';
  ...
  Widget build(BuildContext context) {
    return Scaffold(
        appBar: AppBar(
          title: Text('To Be Read', style: TextStyle(fontFamily: "Caladea", fontSize: 26),),
        ...
        body: Container(
            ...
            child: ListViewBuilderTBR() //uses list view builder widget
        ),
